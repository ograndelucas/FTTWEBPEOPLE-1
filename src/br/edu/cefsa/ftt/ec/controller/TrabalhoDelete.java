...
/**
 * Servlet implementation class TrabalhoDelete
 */
@WebServlet(name = "trabalhoDelete", urlPatterns = { "/trabalhoDelete" })
public class TrabalhoDelete extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TrabalhoDelete() {
        super();
