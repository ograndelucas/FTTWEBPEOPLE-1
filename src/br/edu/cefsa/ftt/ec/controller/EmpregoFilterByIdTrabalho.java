...
/**
 * Servlet implementation class EmpregoFilterByIdTrabalho
 */
@WebServlet(name = "empregoFilterByIdTrabalho", urlPatterns = { "/empregoFilterByIdTrabalho" })
public class EmpregoFilterByIdTrabalho extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EmpregoFilterByIdTrabalho() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			long id = Long.valueOf(request.getParameter("pidTrabalho"));
			List<Emprego> emprega = dao.getEmpregoByIdTrabalho(id);
